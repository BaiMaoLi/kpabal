...
<div class="row" style="margin:10px 0px !important;">
	...
	<div class="col-md-9 col-sm-12">
		...
		<div style="height: 10px;"></div>
		<?php foreach($shopping_categories as $category){			
			$products = $category->products;
			if(count($products) == 0) continue;
		?>
		<nav class="navbar navbar-light bg-light" style="background-color: #007523 !important;">
		  <a class="navbar-brand" href="<?=ROOTPATH?>shopping/category/<?=$category->categoryIdx?>" style="font-size: 16px; padding: 0px;"><?=$category->categoryName?></a>
		</nav>
		<div style="height: 10px;"></div>
		<div class="row">
