            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb" style="height: 30px;">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">My Shopping Mall</li>
                  </ol>
                </nav>
            </div>
            <div class="col-sm-12">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#" role="tab" aria-selected="true">My Malls</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="product-tab" data-toggle="tab" href="#" role="tab" aria-selected="false">My Products</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="order-tab" data-toggle="tab" href="#" role="tab" aria-selected="false">Order History</a>
                  </li>
                  <li class="nav-item">
