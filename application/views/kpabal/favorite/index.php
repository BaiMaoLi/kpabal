        ...
        <div class="row content_container">
            ...
            <div class="col-sm-12">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#" role="tab" aria-selected="true">My Business</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="rating-tab" data-toggle="tab" href="#" role="tab" aria-selected="false">My Favorite</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="review-tab" data-toggle="tab" href="#" role="tab" aria-selected="false">My Reviews</a>
                  </li>
                </ul>
