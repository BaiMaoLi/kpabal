                    ...
                    <table cellspacing="0" cellpadding="0" border="0" id="" class="table table-write">
                        ...
                        <tbody>
                            <tr id="mb_test_tr_title">
                                ...
                                <td>
                                    <input class="text-left" style="width:99%;" name="article_title" id="article_title" value="" type="text">
                                </td>
                            </tr>
                            ...
                            <tr id="mb_test_tr_file1">
                                <th scope="row">
                                    <label for="mb_test_i_file1">File 1</label>
                                </th>
                                <td>
                                    <input type=hidden id="upload_id_1">
                                    <input class="mb-file-upload" style="width:300px;" name="file1" id="mb_test_i_file1" value="" type="file">
                                </td>
                            </tr>
                            <tr id="mb_test_tr_file2">
                                <th scope="row">
                                    <label for="mb_test_i_file2">File 2</label>
                                </th>
                                <td>
                                    <input type=hidden id="upload_id_2">
                                    <input class="mb-file-upload" style="width:300px;" name="file2" id="mb_test_i_file2" value="" type="file">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="write-btn">
                    <div class="btn-box-right" id="test_btn_box">
                        <div class="btn-box-left" style="float:left;">
                            <button class="btn btn-default" title="List" type="button" onclick="top.location.href = '<?=ROOTPATH?>blogs/category/<?=$categoryIdx?>';">
                                <span>List</span>
                            </button>
                        </div>
