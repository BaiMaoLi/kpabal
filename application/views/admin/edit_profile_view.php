                ...
                <section class="content">
                    ...
                    <tr>
                        ...
                        <td><select name="looking_country" id="looking_country" class="form-control">
                            ...
                            <option value="Zambia">Zambia</option>
                            <option value="Zimbabwe">Zimbabwe</option>
<!--<option value="USA" <?php //echo($row->looking_country=='USA')?'selected="selected"':'';?>>USA</option>
    <option value="Pakistan" <?php //echo($row->looking_country=='Pakistan')?'selected="selected"':'';?>>Pakistan</option>-->
</select>
<script>
    var countrySelected = '<?php echo $row->country;?>';
