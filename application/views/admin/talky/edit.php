...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">Update Talky</h3>
            </div>
        </div>
    </div>
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <form method="post" action="<?=ROOTPATH?><?=ADMIN_PUBLIC_DIR?>/talky/insert_talky" enctype="multipart/form-data">
                   <input type="hidden" name="id" value="<?=$talky[0]['id']?>" />
                    <table class="table table-striped- table-bordered table-hover table-checkable">
                        <tr>
                            <td>Author</td>
                            <td><?=$talky[0]['author_data']['user_id']?></td>
                        </tr>
                        <tr>
                            <td>Title</td>
                            <td><input type="text" name="title" maxlength="50" class="form-control" value="<?=$talky[0]['talky_title']?>"></td>
                        </tr>
                        <tr>
                            <td>Contents</td>
                            <td><textarea maxlength="1000" id="content_post" name="content" class="form-control"><?=$talky[0]['talky_desc']?></textarea></td>
                        </tr>
                        <tr>
                            <td>Category</td>
                            <td>
                                <select name="category" class="form-control">
                                    ...
                                    foreach($cats as $cat){
                                        ?>
                                        <option value="<?=$cat['id']?>" <?php if($talky[0]['category']==$cat['id'])echo "selected" ?>><?=$cat['name']?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
