            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-subheader__title m-subheader__title--separator">New Tag</h3>
                    </div>
                </div>
                ...
                <form method="post" action="<?=ROOTPATH?><?=ADMIN_PUBLIC_DIR?>/talky/insert_tag" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable">
                        ...
                        <tr>
                            ...
                            <td>Show/Hide:</td><td ><span class="m-switch" style="display: block;"><label><input type="checkbox" checked="checked" class="form-control" id="isDisplay" name="isDisplay"> <span></span> </label> </span></td>
                        </tr>
