...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">New Category</h3>
            </div>
        </div>
    </div>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <!--begin: Datatable -->
                <form method="post" action="<?=ROOTPATH?><?=ADMIN_PUBLIC_DIR?>/talky/category_insert">
                    <table class="table table-striped- table-bordered table-hover table-checkable">
                        ...
                        <tr><td>Category:</td><td><input type="text" name="name" class="form-control" /></td></tr>
                    </table>
                    <p><button class="btn btn-primary">Insert</button></p>
                </form>
            </div>
        </div>
