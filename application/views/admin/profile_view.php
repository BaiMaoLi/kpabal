                                                                    ...
                                                                    foreach($profiles_view as $profile) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a href="<?php echo base_url(). ADMIN_PUBLIC_DIR. '/edit_profile_admin/edit_profile_detail/'.$profile->username;?>">Edit Profile</a><br/>
                                                                                <a href="<?php echo base_url(). ADMIN_PUBLIC_DIR. '/all_user_freinds/friend_list/'.$profile->id;?>">View Friends List</a><br/>
