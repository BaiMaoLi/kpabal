						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title">Search By Email</h3>
								</div>
								<!-- /.box-header -->
								<form action="<?php echo base_url(). ADMIN_PUBLIC_DIR .'/search_profile_email/result_email';?>" method="post">
									<table width="500" border="0" align="center">
										<tr>
											<td width="132">Search By Email:</td>
