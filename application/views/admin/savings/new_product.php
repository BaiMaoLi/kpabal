    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">New Product</h3>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                ...
                <!--begin: Datatable -->
                <form method="post" action="<?=ROOTPATH?><?=ADMIN_PUBLIC_DIR?>/savings/insert_product" enctype="multipart/form-data">
                    <table class="table table-striped- table-bordered table-hover table-checkable data_table">
                        ...
                        <tr>
                            <td style="width: 150px;">Price</td><td><input type="text" name="price" class="form-control" required /> </td>
                        </tr>
                        <tr>
                            <td style="width: 150px;">Description</td><td><textarea name="description" class="form-control" rows="10"></textarea> </td>
                        </tr>
                        </tbody>
                    </table>
