    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Edit Store</h3>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                ...
                <!--begin: Datatable -->
                <form method="post" action="<?=ROOTPATH?><?=ADMIN_PUBLIC_DIR?>/savings/update_store" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?=$id?>" />
                    <table class="table table-striped- table-bordered table-hover table-checkable data_table">
                        <tbody>
                        <tr>
                            <td style="width: 150px;">Title</td><td colspan="3"><input type="text" name="title" class="form-control" value="<?=$stores[0]['title']?>" required /> </td>
                        </tr>
                        <tr>
                            <td>Address</td><td colspan="3"><input type="text" name="address" class="form-control" value="<?=$stores[0]['address']?>" /></td>
                        </tr>
                        <tr>
                            <td>Zipcod</td><td colspan="3"><input type="text" name="zipcode" class="form-control" value="<?=$stores[0]['zipcode']?>" required /></td>
                        </tr>
                        <tr>
                            <td style="width: 150px;">Logo</td><td>
                                ...
                                if($stores[0]['logo']==""){
                                    ...
                                    ?>
                                    <img src="<?=ROOTPATH ?><?=$stores[0]['logo']?>" id="img_logo" width="200px"/>
                                    <?php
                                }
                                ?>
                            </td>
                            <td style="width: 150px;">Image</td><td>
                                ...
                                if($stores[0]['img']==""){
                                    ...
                                    ?>
                                    <img src="<?=ROOTPATH ?><?=$stores[0]['img']?>" id="img_store" width="200px"/>
                                    <?php
                                }
                                ?>
                            </td>
