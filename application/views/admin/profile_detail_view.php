                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <table width="835" border="0">
                                    <tr>
                                        <td width="325" align="center" valign="top"><img src="<?php echo ($row->photo)? $this->config->item('dating_base_url').'glancePublic/uploads/member_images/'.$row->photo:$this->config->item('dating_base_url').'glancePublic/images/no-image.jpg';?>" width="300" style=" border:2px solid #666; border-radius:5px; margin:4px;" /></td>
                                            ...
                                            if($comment_row) {
                                                foreach($comment_row as $commentDetail) {
                                                    if($commentDetail->photo)
                                                        $image_thumb = $this->config->item('dating_base_url').'glancePublic/uploads/member_images/thumb_'.$commentDetail->photo;
                                                    else
                                                        $image_thumb = $this->config->item('dating_base_url').'glancePublic/images/no-image.jpg';
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td width="53%"><a href="<?php echo base_url(); ?>profile/<?php echo $commentDetail->username; ?>" class="userlink" title="<?php echo $commentDetail->name; ?>"><?php echo $commentDetail->name; ?></a> <span style="float:right;"><a href="<?php echo base_url(). ADMIN_PUBLIC_DIR; ?>/profile_detail/user_comment_delete/<?php echo $row->username; ?>/<?php echo $commentDetail->comment_id; ?>">Delete This Comment</a></span></td>
                                                        <td width="39%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
