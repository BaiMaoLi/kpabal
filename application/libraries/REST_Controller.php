...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __generate_footer_data($header) {
        $footer_data = [];
        $header_data['loggedinuser'] = $header['loggedinuser'];
    ...
    public function __generate_side_data($header_data) {
        $data = [];
        $data['notices'] = $header_data['notices'];
        $data['loggedinuser'] = $header_data['loggedinuser'];
        ...
        $data['news_categories'] = $header_data['news_categories'];
    ...
    public function __construct($config = 'rest')
    {
        ...
        $this->load->library('linkshare_link');
