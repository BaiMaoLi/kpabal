...
class Admin_search_profile_email extends My_controller {
	
	public function __construct()
    {
        parent::__construct();
        $this->header_data                   = $this->__generate_header_data('Profile Management');
        $this->header_data['menuURL']        = "/search_profile_email";
	...
	public function result_email(){
		...
		$profiles_view = $this->dating_member_model->search_member_email($search);
		$data['profiles_view']= $profiles_view;
