...
class Admin_edit_profile_admin extends My_controller
{
	...
	public function __construct()
    {
        ...
        $this->header_data['menuURL']        = "/edit_profile_admin";
    ...
    public function edit_profile_detail($username)
    {
        ...
        $this->dating_member_model->update_member($this->input->post('id'), $member_array);
        //redirect(base_url().'admin/edit_profile_admin/edit_profile_detail/'.$username,'');
        redirect(base_url() . ADMIN_PUBLIC_DIR .'/edit_profile_admin/edit_profile_detail/' . $username, '');
    }
